function [ALPHA_BREAK,clift,clift_q,clift_de,cd0,cd_q,cd_de,cy_b,cy_p,cy_r,cy_de,cy_da,cy_dr,cr_b,cr_p,cr_r,cr_de,cr_da,cr_dr,cm0,cm_de,cm_q,.....
          cn_b,cn_p,cn_r,cn_de,cn_da,cn_dr,thrust,rho] = Aerodata(ALT,x)



global Ixx Iyy Izz S cbar b m g Ixz  r2d d2r ss W;
...
cr_b = [-3.70196E-05   -3.70196E-05   -4.41520E-04   -8.46019E-04   -1.27065E-03 ...
...
cr_p = [-7.05113E-03   -7.05113E-03   -7.05113E-03   -7.05113E-03   -7.05113E-03 ...
...
cr_r = [2.14676E-04    2.14676E-04    2.14676E-04    5.85558E-04    1.52804E-03 ...
...
cr_da = [1.16543E-03    1.16543E-03    1.16543E-03    1.16686E-03    1.17021E-03 ...
...
cr_dr = [2.86293E-04    2.86293E-04    2.86293E-04    2.69213E-04    2.39120E-04 ...
...
% CG location: Fuselage station: 456.88 in = 38.0733 ft = 11.6047 m (Xcg ref from nose coordinates)
% Waterline: 105.35 in = 2.676 m (Zcg ref from nose coordinates)
% Ycg = 0 m 


%Horiz. Dist. CG to main landing gear axle = 1.7545 ft = 0.53462 m
%Vert. Dist. CG to main landing gear axle = 5.4 ft = 1.646 m

%Horiz. Dist. CG to engine nozzle = 16.4 ft = 5 m
%Vert. Dist. CG to engine nozzle = -0.55 ft = -0.1676 m

% To calculate rho at an altitude the standard atmospheric model 
% may be used

% The following was used by the author of this script for some work; if it is found suitable
% you may like to use it as well
...
% Sea-level max. static thrust = 32000 lbs (142.393 KN)
% Formula to compute thrust at an altitude, mach number

thrust = max_thrust * (rho / rho_sl)^0.7 * (1 - exp((ALT - 17000) / 2000));
%thrust = 0.9*max_thrust*(0.88+0.24*(abs(M-0.6))^1.4)*(rho/rho_sl)^0.8;
