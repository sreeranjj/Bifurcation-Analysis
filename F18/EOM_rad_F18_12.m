...
V=200;%100;
alpha=2.7783*d2r;%5.0142*d2r;%21.9467;  %deg value converted to rad
...
theta=2.7783*d2r;%5.0142*d2r;%7.0142;   % theta=alpha+gamma  %deg value converted to rad
psi=0*d2r;  %deg value converted to rad

IC=[V;alpha;beta;p;q;r;phi;theta;psi;xe;ye;ALT];  

del_e=0.1866*d2r;%-0.2409*d2r;%-5.2406;     %deg value converted to rad
del_a=0*d2r;        %deg value converted to rad
del_r=0*d2r;        %deg value converted to rad
eta=0.1996;% 0.3404;%0.6156;
