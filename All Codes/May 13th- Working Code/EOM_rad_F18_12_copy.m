...
V=120;
alpha=8.543343893886711*d2r;%5.0142;  %deg value converted to rad
...
theta=8.543343893886711*d2r;%7.0142;   % theta=alpha+gamma  %deg value converted to rad
psi=0*d2r;  %deg value converted to rad

IC=[V;alpha;beta;p;q;r;phi;theta;psi;xe;ye;ALT];  

del_e=-0.809343405176104*d2r;%-0.2409;     %deg value converted to rad
del_a=0*d2r;        %deg value converted to rad
del_r=0*d2r;        %deg value converted to rad
eta= 0.240475133663416;%0.3404;
