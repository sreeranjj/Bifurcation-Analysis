...
Velocity=120;
alpha=8.626914799287016*d2r;%8.497995890268339*d2r;%;%5.0142;  %deg value converted to rad
beta=0.497561938330999*d2r;%-0.000000054837134*d2r; %deg value converted to rad
...
theta=8.626914799287016*d2r;%8.497995890268339*d2r;%7.0142;   % theta=alpha+gamma  %deg value converted to rad
...
del_e=-1.655500079239364*d2r;%-0.916369995782296*d2r;%-0.2409;     %deg value converted to rad
del_a=-5.618532353068066*d2r;%-0.000000040270334*d2r;        %deg value converted to rad
del_r=1.888977775840741*d2r;%-0.000000281141234*d2r;        %deg value converted to rad
eta= 0.234991293002048;%0.228927295626050;%0.3404;
